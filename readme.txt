...
Tags: feedback, helpdesk, help desk, community, customer community, knowledge base, knowledgebase, customer support, helprace plugin, helprace integration, customer service, service desk, support software, customer service software
...
To see all features check [Helprace features tour](http://helprace.com/feature-list).
...
In the search field type "Helprace Feedback Tab" and click Search Plugins. Once you've found our Helprace Feedback Tab plugin you can install it by simply clicking "Install Now". Activate the plugin and read on "Configuring the feedback tab" section below.
...
2. It has never been so easy to share a good idea
3. Submitting a ticket without leaving your site? Sure thing!
